...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя = "КонтрольРелизов";
	Описание.Версия = "1.26.04.10";
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	Если ТекущаяВерсия = "1.01.2025.43" Тогда
		
		Справочники.ВерсииТехнологическойПлатформы.НачальноеЗаполнение();
		
		Справочники.ВидыКонфигураций.НачальноеЗаполнение();
		Справочники.ВерсииКонфигураций.НачальноеЗаполнение();
		
		Справочники.Подсистемы.НачальноеЗаполнение();
		Справочники.ВерсииПодсистем.НачальноеЗаполнение();
