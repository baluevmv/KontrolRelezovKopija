...
// Синхронизирует версии для всех видов конфигураций с существующими записями в ВерсииКонфигураций.
Процедура ОбновлениеВерсийКонфигураций1С() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбновлениеВерсийКонфигураций1С);
		
	СервисОбновлений1С.ЗапуститьОбновлениеВерсийКонфигураций1С();
	
КонецПроцедуры

Процедура ОбновлениеВерсииПлатформы1С() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбновлениеВерсииПлатформы1С);
	
	СервисОбновлений1С.ЗапуститьОбновлениеВерсииПлатформы1С();
	
КонецПроцедуры

Процедура АктуализацияСостоянийРелизовИБ() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.АктуализацияСостоянийРелизовИБ);
	
	КонтрольРелизов.АктуализацияСостоянийРелизовИБ();
	
КонецПроцедуры

Процедура ФормированиеОповещенийОбОбновлениях() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ФормированиеОповещенийОбОбновлениях);
	
	КонтрольРелизовУведомления.ФормированиеОповещенийОбОбновлениях();
...
Процедура ОтправкаПисемИзОчереди() Экспорт
	...
	КонтрольРелизовУведомления.ОтправкаПисемИзОчереди();	
